...
namespace KhoHang.Class
{
    internal class Function
    {
        ...
        public static void Connect()
        {
            ...
            Conn.ConnectionString = Properties.Settings.Default.DBKhoHangConnectionString;
        ...
        {
            SqlCommand cmd;//Doi tuong thuoc lop SqlCommand
            cmd = new SqlCommand();
            cmd.Connection = Conn;
            cmd.CommandText = sql;
            try
            {
                cmd.ExecuteNonQuery();//Thu hien cau lenh  sql
            }
            catch(Exception ex)
            {
